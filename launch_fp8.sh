...
TRANSFORMER_ENGINE_ARGS=(
    ...
    --fp8-format 'e4m3'           # Best precision for the forward pass
    --fp8-amax-history-len 1024   # Stabilizes scaling across iterations
    --fp8-amax-compute-algo max   # The standard for GH200 optimization
)
...
TRAINING_CMD="nsys profile \
    ...
    -o /iopsstor/scratch/cscs/course_00191/Gipfelsturm/logs/gipfel_fp8_profile \
